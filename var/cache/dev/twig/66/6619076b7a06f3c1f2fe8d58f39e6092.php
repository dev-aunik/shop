...
class __TwigTemplate_58d603e4da3db7bb073250e543814af6 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 6, $this->source); })()), "messages", [], "any", false, false, true, 6))) {
            ...
            // line 8
            echo "            ";
            echo $this->extensions['Eccube\Twig\Extension\IgnoreTwigSandboxErrorExtension']->twig_include($this->env, $context, "@WebProfiler/Icon/translation.svg");
            echo "
            ";
            // line 9
        ...
        ";
            // line 41
            echo $this->extensions['Eccube\Twig\Extension\IgnoreTwigSandboxErrorExtension']->twig_include($this->env, $context, "@WebProfiler/Profiler/toolbar_item.html.twig", ["link" => (isset($context["profiler_url"]) || array_key_exists("profiler_url", $context) ? $context["profiler_url"] : (function () { throw new RuntimeError('Variable "profiler_url" does not exist.', 41, $this->source); })()), "status" => (isset($context["status_color"]) || array_key_exists("status_color", $context) ? $context["status_color"] : (function () { throw new RuntimeError('Variable "status_color" does not exist.', 41, $this->source); })())]);
            echo "
    ";
        }
    ...
    public function macro_render_table($__messages__ = null, $__is_fallback__ = null, ...$__varargs__)
    {
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                ...
                // line 180
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["message"], "locale", [], "any", false, false, true, 180), 180, $this->source), "html", null, true);
                echo "</td>
                ";
                // line 181
                if ((isset($context["is_fallback"]) || array_key_exists("is_fallback", $context) ? $context["is_fallback"] : (function () { throw new RuntimeError('Variable "is_fallback" does not exist.', 181, $this->source); })())) {
                    ...
                    echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, $context["message"], "fallbackLocale", [], "any", true, true, true, 182)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["message"], "fallbackLocale", [], "any", false, false, true, 182), 182, $this->source), "-")) : ("-")), "html", null, true);
                    echo "</td>
                ";
                }
                // line 184
                echo "                <td class=\"font-normal text-small text-bold nowrap\">";
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["message"], "domain", [], "any", false, false, true, 184), 184, $this->source), "html", null, true);
                echo "</td>
                <td class=\"font-normal text-small nowrap\">";
                // line 185
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["message"], "count", [], "any", false, false, true, 185), 185, $this->source), "html", null, true);
                echo "</td>
                <td>
                    <span class=\"nowrap\">";
                // line 187
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["message"], "id", [], "any", false, false, true, 187), 187, $this->source), "html", null, true);
                echo "</span>

                    ";
                // line 189
                if ( !(null === twig_get_attribute($this->env, $this->source, $context["message"], "transChoiceNumber", [], "any", false, false, true, 189))) {
                    // line 190
                ...
                echo "
                    ";
                // line 193
                if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["message"], "parameters", [], "any", false, false, true, 193)) > 0)) {
                    // line 194
                    ...
                    // line 197
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["message"], "parameters", [], "any", false, false, true, 197));
                    foreach ($context['_seq'] as $context["_key"] => $context["parameters"]) {
                        // line 198
                        echo "                                ";
                        echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, $this->sandbox->ensureToStringAllowed($context["parameters"], 198, $this->source), 1);
                        echo "
                            ";
                    }
                    $_parent = $context['_parent'];
                ...
                <td class=\"prewrap\">";
                // line 203
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["message"], "translation", [], "any", false, false, true, 203), 203, $this->source), "html", null, true);
                echo "</td>
            </tr>
        ";
                ++$context['loop']['index0'];
...
";
    ...
    {
        return array (  654 => 206,  637 => 203,  634 => 202,  630 => 200,  621 => 198,  617 => 197,  613 => 196,  607 => 194,  605 => 193,  602 => 192,  598 => 190,  596 => 189,  591 => 187,  586 => 185,  581 => 184,  575 => 182,  573 => 181,  569 => 180,  566 => 179,  549 => 178,  540 => 171,  536 => 169,  534 => 168,  528 => 164,  508 => 163,  495 => 151,  485 => 150,  472 => 129,  462 => 128,  449 => 108,  439 => 107,  425 => 154,  422 => 153,  419 => 150,  413 => 146,  411 => 145,  397 => 136,  393 => 135,  388 => 132,  385 => 131,  382 => 128,  376 => 124,  374 => 123,  361 => 115,  355 => 111,  352 => 110,  349 => 107,  343 => 103,  341 => 102,  331 => 95,  327 => 94,  323 => 92,  317 => 91,  314 => 90,  311 => 89,  308 => 88,  305 => 87,  302 => 86,  299 => 85,  296 => 84,  291 => 83,  288 => 82,  285 => 80,  275 => 79,  264 => 160,  261 => 159,  258 => 79,  252 => 75,  250 => 74,  241 => 68,  237 => 67,  230 => 63,  224 => 59,  214 => 58,  203 => 55,  197 => 52,  194 => 51,  191 => 50,  189 => 49,  184 => 47,  177 => 46,  167 => 45,  154 => 41,  151 => 40,  145 => 37,  136 => 31,  132 => 30,  123 => 24,  119 => 23,  111 => 18,  106 => 15,  104 => 14,  101 => 13,  95 => 11,  92 => 10,  90 => 9,  85 => 8,  82 => 7,  79 => 6,  69 => 5,  58 => 1,  56 => 3,  43 => 1,);
    }
...
{% endmacro %}
", "@WebProfiler/Collector/translation.html.twig", "F:\\laragon\\www\\shop\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\translation.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("import" => 3, "if" => 6, "set" => 7, "block" => 79, "for" => 83, "macro" => 163);
        static $filters = array("length" => 6, "escape" => 11, "default" => 18, "join" => 67, "merge" => 85);
        static $functions = array("include" => 8, "constant" => 84, "profiler_dump" => 198);
