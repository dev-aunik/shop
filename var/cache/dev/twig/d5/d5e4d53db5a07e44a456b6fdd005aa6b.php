...
class __TwigTemplate_7ca1784f6d28830ac335bc6ae74abfaa extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (((isset($context["position"]) || array_key_exists("position", $context) ? $context["position"] : (function () { throw new RuntimeError('Variable "position" does not exist.', 9, $this->source); })()) != "left")) {
            $context["classes"] = twig_array_merge($this->sandbox->ensureToStringAllowed((isset($context["classes"]) || array_key_exists("classes", $context) ? $context["classes"] : (function () { throw new RuntimeError('Variable "classes" does not exist.', 9, $this->source); })()), 9, $this->source), [0 => ("is-" . $this->sandbox->ensureToStringAllowed((isset($context["position"]) || array_key_exists("position", $context) ? $context["position"] : (function () { throw new RuntimeError('Variable "position" does not exist.', 9, $this->source); })()), 9, $this->source))]);
        }
        // line 10
        if ((isset($context["rounded"]) || array_key_exists("rounded", $context) ? $context["rounded"] : (function () { throw new RuntimeError('Variable "rounded" does not exist.', 10, $this->source); })())) {
            $context["classes"] = twig_array_merge($this->sandbox->ensureToStringAllowed((isset($context["classes"]) || array_key_exists("classes", $context) ? $context["classes"] : (function () { throw new RuntimeError('Variable "classes" does not exist.', 10, $this->source); })()), 10, $this->source), [0 => "is-rounded"]);
        }
        // line 11
        if (((isset($context["size"]) || array_key_exists("size", $context) ? $context["size"] : (function () { throw new RuntimeError('Variable "size" does not exist.', 11, $this->source); })()) != null)) {
            $context["classes"] = twig_array_merge($this->sandbox->ensureToStringAllowed((isset($context["classes"]) || array_key_exists("classes", $context) ? $context["classes"] : (function () { throw new RuntimeError('Variable "classes" does not exist.', 11, $this->source); })()), 11, $this->source), [0 => ("is-" . $this->sandbox->ensureToStringAllowed((isset($context["size"]) || array_key_exists("size", $context) ? $context["size"] : (function () { throw new RuntimeError('Variable "size" does not exist.', 11, $this->source); })()), 11, $this->source))]);
        }
        // line 12
        echo "
";
...
{% endif %}
", "@KnpPaginator/Pagination/bulma_pagination.html.twig", "F:\\laragon\\www\\shop\\vendor\\knplabs\\knp-paginator-bundle\\templates\\Pagination\\bulma_pagination.html.twig");
    }
