...
class getGeneratorService extends Eccube_KernelDevDebugContainer
{
    ...
    {
        if ($lazyLoad) {
            return $container->privates['Eccube\\Tests\\Fixture\\Generator'] = $container->createProxy('Generator_4137487', function () use ($container) {
                return \Generator_4137487::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
