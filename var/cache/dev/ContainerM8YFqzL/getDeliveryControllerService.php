...
class getDeliveryControllerService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.GfEoImZ'] ?? $container->load('get_ServiceLocator_GfEoImZService'))->withContext('Eccube\\Controller\\Admin\\Setting\\Shop\\DeliveryController', $container));
