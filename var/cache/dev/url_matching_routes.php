...
return [
    ...
    [ // $staticRoutes
        ...
        '/robotpayment/excute' => [[['_route' => 'robotpayment_excute', '_controller' => 'Eccube\\Controller\\ShoppingController::robotPaymentExcute'], null, ['POST' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/robotpayment/excute/test' => [[['_route' => 'robotpayment_excute_test', '_controller' => 'Eccube\\Controller\\ShoppingController::robotPaymentExcuteTest'], null, ['POST' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        ...
        '/api/custom_login' => [[['_route' => 'custom_login', '_controller' => 'Customize\\Controller\\CustomerController::customLogin'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/api/customers_list' => [[['_route' => 'customize_customer_viewcustomerslist', '_controller' => 'Customize\\Controller\\CustomerController::viewCustomersList'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/api/add_customer' => [[['_route' => 'customize_customer_addcustomer', '_controller' => 'Customize\\Controller\\CustomerController::addCustomer'], null, ['POST' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/api/orders' => [[['_route' => 'customize_order_customerorders', '_controller' => 'Customize\\Controller\\OrderController::customerOrders'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/api/order_details' => [[['_route' => 'customize_order_orderdetails', '_controller' => 'Customize\\Controller\\OrderController::orderDetails'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/api/prefectures' => [[['_route' => 'customize_prefecture_prefectures', '_controller' => 'Customize\\Controller\\PrefectureController::prefectures'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/api/products' => [[['_route' => 'customize_product_productlist', '_controller' => 'Customize\\Controller\\ProductController::productList'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/api/add_product' => [[['_route' => 'customize_product_addproducts', '_controller' => 'Customize\\Controller\\ProductController::addProducts'], null, ['POST' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/api/categories' => [[['_route' => 'customize_product_categorylist', '_controller' => 'Customize\\Controller\\ProductController::categoryList'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .')'
                .'|/cart/(?'
                    .'|(up|down|remove)/(\\d+)(*:2419)'
                    .'|buystep/([a-zA-Z0-9]+[_][\\x20-\\x7E]+)(*:2465)'
                .')'
                .'|/entry/activate/([^/]++)(?:/([^/]++))?(*:2513)'
                .'|/forgot/reset/([^/]++)(*:2544)'
                .'|/install/plugin/(\\w+)/enable(*:2581)'
                .'|/mypage/(?'
                    .'|delivery/(?'
                        .'|(\\d+)/edit(*:2623)'
                        .'|([^/]++)/delete(*:2647)'
                ...
                .'|/s(?'
                    .'|hopping/shipping(?'
                        ...
                        .'|_edit/(\\d+)(*:2871)'
                    .')'
                    .'|itemap_product_(\\d+)\\.xml(*:2906)'
                .')'
                .'|/user_data/((?:[0-9a-zA-Z_\\-]+\\/?)+(?<!\\/))(*:2959)'
            .')/?$}sD',
    ],
    [ // $dynamicRoutes
        ...
        2239 => [[['_route' => 'customize_customer_updatecustomerprofile', '_controller' => 'Customize\\Controller\\CustomerController::updateCustomerProfile'], ['customer_id'], ['POST' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2267 => [[['_route' => 'customize_product_updateproduct', '_controller' => 'Customize\\Controller\\ProductController::updateProduct'], ['id'], ['POST' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2292 => [[['_route' => 'customize_product_updateproductstatus', '_controller' => 'Customize\\Controller\\ProductController::updateProductStatus'], ['id'], ['POST' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2319 => [[['_route' => 'customize_product_viewproduct', '_controller' => 'Customize\\Controller\\ProductController::viewProduct'], ['product_id'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2351 => [[['_route' => 'customize_product_deleteproduct', '_controller' => 'Customize\\Controller\\ProductController::deleteProduct'], ['id'], ['POST' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2377 => [[['_route' => 'customize_product_viewcategory', '_controller' => 'Customize\\Controller\\ProductController::viewCategory'], ['category_id'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2419 => [[['_route' => 'cart_handle_item', '_controller' => 'Eccube\\Controller\\CartController::handleCartItem'], ['operation', 'productClassId'], ['PUT' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2465 => [[['_route' => 'cart_buystep', '_controller' => 'Eccube\\Controller\\CartController::buystep'], ['cart_key'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2513 => [[['_route' => 'entry_activate', 'qtyInCart' => null, '_controller' => 'Eccube\\Controller\\EntryController::activate'], ['secret_key', 'qtyInCart'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2544 => [[['_route' => 'forgot_reset', '_controller' => 'Eccube\\Controller\\ForgotController::reset'], ['reset_key'], ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, true, null]],
        2581 => [[['_route' => 'install_plugin_enable', '_controller' => 'Eccube\\Controller\\InstallPluginController::pluginEnable'], ['code'], ['PUT' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        2623 => [[['_route' => 'mypage_delivery_edit', 'id' => null, '_controller' => 'Eccube\\Controller\\Mypage\\DeliveryController::edit'], ['id'], ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, false, null]],
        2647 => [[['_route' => 'mypage_delivery_delete', '_controller' => 'Eccube\\Controller\\Mypage\\DeliveryController::delete'], ['id'], ['DELETE' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        2673 => [[['_route' => 'mypage_history', '_controller' => 'Eccube\\Controller\\Mypage\\MypageController::history'], ['order_no'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2696 => [[['_route' => 'mypage_order', '_controller' => 'Eccube\\Controller\\Mypage\\MypageController::order'], ['order_no'], ['PUT' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2726 => [[['_route' => 'mypage_favorite_delete', '_controller' => 'Eccube\\Controller\\Mypage\\MypageController::delete'], ['id'], ['DELETE' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        2761 => [[['_route' => 'product_detail', '_controller' => 'Eccube\\Controller\\ProductController::detail'], ['id'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2791 => [[['_route' => 'product_add_favorite', '_controller' => 'Eccube\\Controller\\ProductController::addFavorite'], ['id'], ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, true, null]],
        2810 => [[['_route' => 'product_add_cart', '_controller' => 'Eccube\\Controller\\ProductController::addCart'], ['id'], ['POST' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2851 => [[['_route' => 'shopping_shipping', '_controller' => 'Eccube\\Controller\\ShoppingController::shipping'], ['id'], ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, true, null]],
        2871 => [[['_route' => 'shopping_shipping_edit', '_controller' => 'Eccube\\Controller\\ShoppingController::shippingEdit'], ['id'], ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, true, null]],
        2906 => [[['_route' => 'sitemap_product_xml', '_controller' => 'Eccube\\Controller\\SitemapController::product'], ['page'], ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        2959 => [
