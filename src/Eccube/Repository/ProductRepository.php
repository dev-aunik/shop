...
class ProductRepository extends AbstractRepository
{
    ...
    public function getQueryBuilderBygetNewArrivalByCategory(){

        $qb = $this->createQueryBuilder('p')->andWhere('p.Status = 1');
        $parentCategories = $this->getEntityManager()->getRepository('Eccube\Entity\Category')->getList();
        
        if (count($parentCategories) > 0) {
            $singleProductForEachParentCategory = [];
            foreach ($parentCategories as $parentCategory) {
                $Categories = $parentCategory->getSelfAndDescendants();
                if ($Categories) {
                    ...
                    $singleProductForEachParentCategory[] = reset($result);
        ...
        return $singleProductForEachParentCategory;
    }
}
